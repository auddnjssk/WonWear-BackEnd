...
public class CommonUtil {
    ...
    public List<Map<String,Object>> supaBaseSelect(String tableName,String condition){
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.isSuccessful()) {
            	...
            	responseData = "오류 발생: " + response.code() + " - " + response.message() +" hint :" +response.body().string();
            	ListResponse = objectMapper.readValue(responseData, new TypeReference<List<Map<String,Object>>>() {});
                return ListResponse;
            }
        } catch (Exception e) {
    ...
    // SupaBase Update 메소드
    public ResponseEntity<String> supaBaseUpdate(String tableName,String condition,JsonObject body) {
   ...
   // UserId 추출
   public String claimsJwtData(String authorizationHeader) {
   ...
   // JSON 문자열을 List<Map<String,Object>> 형태로 파싱
   public List<Map<String, Object>> parseJsonString(String jsonString) {
